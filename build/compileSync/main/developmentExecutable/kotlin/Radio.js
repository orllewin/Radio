(function (root, factory) {
  ...
  function main$lambda$lambda($backButton, $settingsLayout, $settingsButton, $grid, $urlTextArea) {
    return function (it) {
      ...
      var tmp2_safe_receiver = $grid;
      if (tmp2_safe_receiver == null)
        null;
      else {
        tmp2_safe_receiver.setAttribute('style', 'display: none;');
        Unit_getInstance();
      }
      Unit_getInstance();
      var tmp$ret$1;
      ...
      if (tmp3_safe_receiver == null)
        ...
        $l$block_1: {
          ...
          tmp$ret$2 = $urlTextArea.value = tmp3_safe_receiver;
          break $l$block_1;
        }
        Unit_getInstance();
      }
  ...
  function main$lambda$lambda_1($backButton, $settingsLayout, $settingsButton, $grid) {
    return function (it) {
      ...
      if (tmp2_safe_receiver == null)
        ...
        tmp2_safe_receiver.setAttribute('style', 'display: grid;');
        Unit_getInstance();
      }
      Unit_getInstance();
      return Unit_getInstance();
  ...
  function main$lambda() {
    return function (it) {
      ...
      if (tmp1_safe_receiver == null)
        ...
        tmp1_safe_receiver.addEventListener('click', main$lambda$lambda(backButton, settingsLayout, settingsButton, grid, urlTextArea));
        Unit_getInstance();
      }
      Unit_getInstance();
      ...
      if (tmp3_safe_receiver == null)
        ...
        tmp3_safe_receiver.addEventListener('click', main$lambda$lambda_1(backButton, settingsLayout, settingsButton, grid));
        Unit_getInstance();
      }
      Unit_getInstance();
      var tmp_3;
